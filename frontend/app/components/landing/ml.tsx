...
const BRAND_MOTTO = "Timeless scents, reimagined";
      ...
      <div className="relative z-10 flex flex-col items-center w-full">
          ...
          >
            <span className="relative inline-block overflow-hidden pb-2 md:pb-4">
              <motion.span 
                ...
                className="block uppercase text-shimmer" 
              >
                {firstLine}
              </motion.span>
            </span>
        ...
        >
          ...
          <div className="flex flex-col items-center gap-4">
            <Link to="/products" className={`group relative px-10 md:px-16 py-4 md:py-6 bg-transparent overflow-hidden cursor-pointer ${
              isDarkTheme 
